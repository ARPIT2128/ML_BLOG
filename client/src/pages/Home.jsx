...
import "./Home.scss"; // Import your SCSS file here
...
const Home = () => {
  const carouselItems = [
    {
      ...
      link: "http://localhost:5173/Single",
      description:
  ...
  return (
    <>
      <div className="main_tab jumbotron p-4 p-md-5 text-black rounded">
        <div className="col-md-6 px-0">
          <h1 className="display-4 font-italic">
            Unraveling the Wonders of Machine Learning
          </h1>
          <p className="lead my-3">
            Discover the latest breakthroughs, trends, and insights in the world
            of machine learning. Dive into captivating stories that explore the
            limitless possibilities of artificial intelligence.
          </p>
          <p className="lead mb-0">
            <a className="text-black font-weight-bold">Continue reading...</a>
          </p>
        </div>
      </div>
